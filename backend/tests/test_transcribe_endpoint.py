...
@pytest.mark.asyncio
async def test_transcribe_audio_invalid_file_type(async_client, mock_transcription_model_fixture):
    """
...
@pytest.mark.asyncio
async def test_transcribe_audio_unsupported_extension(async_client, mock_transcription_model_fixture):
    """
